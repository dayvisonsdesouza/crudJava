...
public class Principal extends javax.swing.JFrame {
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        try {
            mysql.getConsulta().executeUpdate("INSERT INTO cadastro (nome, telefone) values('"+campoNome.getText()+"','"+campoTelefone.getText()+"')");
            JOptionPane.showMessageDialog(this, "Cadastro efetuado com sucesso!");
        } catch(Exception erro) {
            System.out.println("Erro ao tentar executar o cadastro!");
        }
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        try {
            int id = Integer.parseInt(JOptionPane.showInputDialog(this, "Digite o ID: "));
            mysql.getConsulta().executeUpdate("delete from cadastro where id = " + id);
            JOptionPane.showMessageDialog(this, "Cadastro excluído com sucesso!");
        } catch(Exception erro) {
            System.out.println("Erro ao tentar excluir o cadastro!");
        }
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ...
        try {
            int id = Integer.parseInt(JOptionPane.showInputDialog(this, "Digite o ID que você deseja editar:"));
            ...
            mysql.getConsulta().executeUpdate("update cadastro set nome = '"+nome+"', telefone = '"+telefone+"' where id = " + id);
            JOptionPane.showMessageDialog(this, "Cadastro editado com sucesso!");
        } catch(Exception erro) {
            System.out.println("Erro ao tentar editar o cadastro!");
        }
    ...
    private void botaoListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoListarActionPerformed
        ...
        try {
            ResultSet tabela = mysql.getConsulta().executeQuery("SELECT * FROM cadastro");
            ...
            campoListar.setText(relatorio);
        } catch(Exception erro) {
            System.out.println("Erro ao tentar listar cadastro!");
        }
